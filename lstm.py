...
# load dataset
series = read_csv('pm25_content_nj.csv', header=0, parse_dates=[0], index_col=0, squeeze=True, date_parser=parser)
...
test_len = round(len(raw_values) * -0.3)
...
for i in range(len(test_scaled)):
	...
	print('date=%s, Predicted=%f, Expected=%f' % (raw_index[len(train) + i + 1], yhat, expected))
